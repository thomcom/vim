""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
" DIE BLINKËNMATCHEN - Enhanced search match highlighting
""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
" Modified version of Damian Conway's brilliant search match blinker
" Makes your search matches blink briefly so you can see exactly what matched
" 
" Original: https://github.com/thoughtstream/Damian-Conway-s-Vim-Setup
""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""

" Blink duration in milliseconds
" Shorter for older vim (blocks during blink), longer for modern vim with timers
